...
// const RawDatasetWorkspace = () => {
//   const { dataset } = useParams(); // Get the pipeline ID from the URL
...
//       const getData = async () => {
//         try {
//           const response = await fetchCsvData(dataset); // Fetch data for selected table
//           setData(response.data);
//         } catch (error) {
//           console.error("Error fetching data:", error);
//         }
...
//         getData();
//       }
//     }, [dataset]); // Dependency on fileName

//   return (
//     <div style={{ margin: 0, padding: 0, height: "100vh", overflow: "hidden" }}>
//       <h1>Raw Dataset Workspace</h1>
//       <p>Dataset Name: {dataset}</p>
//       {/* Add your workspace-specific UI here */}
